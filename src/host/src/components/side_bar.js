...
export default function Sidebar() {
  return (
    <div className="sidebar-main">
      ...
      <div className="sidebar-func">
        <NavLink to="order" className="sidebar-func-a">
      ...
      <div className="sidebar-func">
        <NavLink to="transaction" className="sidebar-func-a">
      ...
      <div className="sidebar-func">
        <NavLink to="manage" className="sidebar-func-a">
      ...
      <div className="sidebar-func">
        <NavLink to="trategy" className="sidebar-func-a">
